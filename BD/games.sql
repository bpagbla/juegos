...
#Games
INSERT INTO juego (ID, TITULO, RUTA, PORTADA, DESARROLLADOR, DISTRIBUIDOR, ANIO) VALUES (150886, 'Truck Racer', 'algo', 'portada', 6920, 20858,2013);
INSERT INTO juego (ID, TITULO, RUTA, PORTADA, DESARROLLADOR, DISTRIBUIDOR, ANIO) VALUES (63690, 'Pako 2', 'algo2', 'portada2', 16712, 16712,1995);
INSERT INTO juego (ID, TITULO, RUTA, PORTADA, DESARROLLADOR, DISTRIBUIDOR, ANIO) VALUES (136678, 'Afterparty', 'algo3', 'portada3', 24675, 24675,2020);
INSERT INTO juego (ID, TITULO, RUTA, PORTADA, DESARROLLADOR, DISTRIBUIDOR, ANIO) VALUES (73736, 'Tengami', 'algo4', 'portada4', 23619, 23619,2014);
INSERT INTO juego (ID, TITULO, RUTA, PORTADA, DESARROLLADOR, DISTRIBUIDOR, ANIO) VALUES (190922, 'Oxenfree II: Lost Signals',  'algo5','portada5', 24675, 26326,2023);
