...
CREATE TABLE presta (
  ...
  `ID_US2` int NOT NULL,
  `FECHA` date NOT NULL,
  PRIMARY KEY (`ID_JUEGO`,`ID_US1`,`ID_US2`,`FECHA`),
  KEY `FK_PRES_IDU1_USU_ID` (`ID_US1`),
  KEY `FK_PRES_IDU2_USU_ID` (`ID_US2`),
  CONSTRAINT `FK_PRES_IDJ_JUE_ID` FOREIGN KEY (`ID_JUEGO`) REFERENCES `juego` (`ID`) ON DELETE CASCADE,
  CONSTRAINT `FK_PRES_IDU1_USU_ID` FOREIGN KEY (`ID_US1`) REFERENCES `usuario` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK_PRES_IDU2_USU_ID` FOREIGN KEY (`ID_US2`) REFERENCES `usuario` (`id`) ON DELETE CASCADE
);
...
CREATE TABLE juego_genero (
  ...
  CONSTRAINT `FK_JGEN_IDJ_GEN_ID` FOREIGN KEY (`ID_GENERO`) REFERENCES `genero` (`ID`) ON DELETE CASCADE,
  CONSTRAINT `FK_JGEN_IDJ_JUE_ID` FOREIGN KEY (`ID_JUEGO`) REFERENCES `juego` (`ID`) ON DELETE CASCADE
);
...
CREATE TABLE juego_sistema (
  ...
  CONSTRAINT `FK_JSIST_IDJ_JUE_ID` FOREIGN KEY (`ID_JUEGO`) REFERENCES `juego` (`ID`) ON DELETE CASCADE,
  CONSTRAINT `FK_JSIST_IDJ_SIST_ID` FOREIGN KEY (`ID_SIST`) REFERENCES `sistema` (`ID`) ON DELETE CASCADE
);
...
#Games
INSERT INTO juego (ID, TITULO, DESCRIPCION, RUTA, PORTADA, DESARROLLADOR, DISTRIBUIDOR, ANIO, PRECIO) VALUES (150886, 'Truck Racer', '', 'games/150886.jsdos', 'img/game-thumbnail/150886.webp', 6920, 20858,2013, 1234);
INSERT INTO juego (ID, TITULO, DESCRIPCION, RUTA, PORTADA, DESARROLLADOR, DISTRIBUIDOR, ANIO, PRECIO) VALUES (63690, 'Pako 2', '', 'games/63690.jsdos', 'img/game-thumbnail/63690.webp', 16712, 16712,1995, 1234);
INSERT INTO juego (ID, TITULO, DESCRIPCION, RUTA, PORTADA, DESARROLLADOR, DISTRIBUIDOR, ANIO, PRECIO) VALUES (136678, 'Afterparty', '', 'games/136678.jsdos', 'img/game-thumbnail/136678.webp', 24675, 24675,2020, 1234);
INSERT INTO juego (ID, TITULO, DESCRIPCION, RUTA, PORTADA, DESARROLLADOR, DISTRIBUIDOR, ANIO, PRECIO) VALUES (73736, 'Tengami', '', 'games/73736.jsdos', 'img/game-thumbnail/73736.webp', 23619, 23619,2014, 1234);
INSERT INTO juego (ID, TITULO, DESCRIPCION, RUTA, PORTADA, DESARROLLADOR, DISTRIBUIDOR, ANIO, PRECIO) VALUES (190922, 'Oxenfree II: Lost Signals',  '', 'games/190922.jsdos','img/game-thumbnail/190922.webp', 24675, 26326,2023, 1234);
...
INSERT INTO juego_sistema(ID_JUEGO,ID_SIST) VALUES (150886,1);
INSERT INTO juego_sistema(ID_JUEGO,ID_SIST) VALUES (63690,1);
INSERT INTO juego_sistema(ID_JUEGO,ID_SIST) VALUES (136678,1);
INSERT INTO juego_sistema(ID_JUEGO,ID_SIST) VALUES (73736,1);
INSERT INTO juego_sistema(ID_JUEGO,ID_SIST) VALUES (190922,1);

INSERT INTO juego_genero(ID_JUEGO,ID_GENERO) VALUES (150886,1);
INSERT INTO juego_genero(ID_JUEGO,ID_GENERO) VALUES (63690,1);
INSERT INTO juego_genero(ID_JUEGO,ID_GENERO) VALUES (136678,1);
INSERT INTO juego_genero(ID_JUEGO,ID_GENERO) VALUES (73736,1);
INSERT INTO juego_genero(ID_JUEGO,ID_GENERO) VALUES (190922,1);
...
INSERT INTO tarjeta_bancaria(ID_USUARIO,NUMERO,CVV,FECHA_CADUC) VALUES (2,6319038988203452,723,DATE '2023-11-01');


#promociones
INSERT INTO promocion(ID, NOMBRE, FECHA, DESCUENTO, DIAS) VALUES(1, 'PRUEBA', DATE "2025-02-12", 50, 3);