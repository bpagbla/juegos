...
<head>
    ...
    <title>Glitched Pixel | Registro</title>
...
<body class="bg-body-tertiary">
    ...
    <div class="toast-container position-fixed top-0 start-0 p-3">
        <div id="toastErrorPasswd" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
            <div class="toast-header">
                <strong class="me-auto">Error de Registro</strong>
                <small>Ahora</small>
                <button type="button" class="btn-close" data-bs-dismiss="toast" aria-label="Close"></button>
            ...
            <div class="row g-5 justify-content-center">
                <div class="col-md-7 col-lg-8">
                    <form class="needs-validation" method="post" action="#" novalidate>
                        ...
                        <div class="row mt-3">
                            <div class="col">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="save-info" name="tyc" <?php if (!empty($_POST["tyc"])) {
                                        print "checked";
                                    } ?> required>
                        ...
                        <button class="w-100 btn btn-primary btn-lg estiloBoton border-0"
